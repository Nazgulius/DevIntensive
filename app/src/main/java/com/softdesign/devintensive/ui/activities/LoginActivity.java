...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<Repository> getRepoListFromUserRes(UserListRes.UserData userDate){
        final String userId = userDate.getId();

        List<Repository> repositories = new ArrayList<>();
        for(UserModelRes.Repo repositoryRes : userDate.getRepositories().getRepo()){
